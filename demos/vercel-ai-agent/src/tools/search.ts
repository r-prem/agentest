    ...
    const mockResults = [
      {
        ...
        snippet: `Overview article about ${query} with detailed information.`,
      },
      {
        title: `Understanding ${query} | Blog`,
        snippet: `A comprehensive guide to ${query} and its applications.`,
      },
      {
        title: `${query} explained simply`,
        snippet: `Simple explanation of ${query} for beginners.`,
      },
      {
